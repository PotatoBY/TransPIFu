...
def compute_split_range(testing_inds, args):
    ...
    for eachTestIdx in testing_inds[splitRange[0]:splitRange[1]]:
        ...
        rgbImagePath = "%s/rgbImage/%06d.png"%(args.datasetDir,eachTestIdx)
...
class Evaluator:
    ...
    def load_image(self, normal_path, image_path, mask_path, idx, args):
        ...
        if True:
            ...
            meshName = image_path.split("/")[-3] + "+" + image_path.split("/")[-2]
            print(meshName)
...
def main(args):
    ...
    for pathList in testIdxList:
        ...
        """
        data = evaluator.load_image(normal_path=pathList[3],image_path=pathList[2], mask_path=pathList[1], idx=frameIdx[1], args=args)
