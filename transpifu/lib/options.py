...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_ours.add_argument('--normal_activate', action='store_true', help='load the normal image')
        g_ours.add_argument('--depth_activate', action='store_true', help='load the depth image')
        ...
        # transformer
        g_model.add_argument('--img_size', type=int, default=512, help='input patch size of network input')
        g_model.add_argument('--n_skip', type=int, default=3, help='using number of skip-connect, default is num')
        g_model.add_argument('--vit_name', type=str, default='R50-ViT-B_16', help='select one vit model')
        g_model.add_argument('--vit_patches_size', type=int, default=16, help='vit_patches_size, default is 16')
