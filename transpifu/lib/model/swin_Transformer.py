...
class Transformer(nn.Module):
    ...
    def __init__(self, img_size=512, config=None, patch_size=16, in_chans=3, num_classes=1000,
        ...
        if self.hybrid:
            ...
            # in_chans = self.hybrid_model.width * 16
    ...
    def forward_features(self, x):
        if self.hybrid:
            _, features = self.hybrid_model(x)
        else:
            features = None
...
class DecoderCup(nn.Module):
    ...
    def forward(self, hidden_states, features=None):
        ...
        # print(x.shape)
        if x.shape[2]!=32:
            x = F.interpolate(x, scale_factor=32//x.shape[2], mode='bicubic', align_corners=True)
...
class VrnNet(nn.Module):
    def __init__(self, opt, projection_mode='orthogonal'):
        ...
        if True:
            ...
            for hg_module in range(self.opt.vrn_num_modules):  # default: 4
                ...
                self.add_module("branch_out_3d_unet" + str(hg_module), Unet3D(c_len_in=c_len_deepvoxels,
    ...
    def forward(self, images):
        ...
        for i in range(self.opt.vrn_num_modules):  # default: 4
            ...
            tmp_out = tmp_out.view(tmp_out.shape[0], -1, 96, tmp_out.shape[-2],
