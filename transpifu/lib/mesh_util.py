...
#700000
def reconstruction_iccv(net, cuda, calib_tensor, resolution_x, resolution_y, resolution_z, b_min, b_max, use_octree=False, num_samples=300000, transform=None, deepVoxels=None):
    '''
